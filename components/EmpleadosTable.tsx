// ═══════════════════════════════════════════════════════════
// Componente EmpleadosTable - Tabla interactiva (cliente)
...
// Formatea valores para mostrar en celda
...
export default function EmpleadosTable({ data }: { data: Row[] }) {
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
        <p className="text-sm text-gray-600">
          ...
          <code className="bg-gray-100 px-1 rounded">empleados</code> tenga datos
          y que las políticas RLS permitan la lectura al usuario autenticado.
        </p>
      </div>
    )
  }
